...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-this-in-production-with-a-real-secret-key')
...
if 'CLOUDINARY_CLOUD_NAME' in os.environ:
    ...
    MEDIA_URL = '/media/'  # Cloudinary gestisce automaticamente l'URL
